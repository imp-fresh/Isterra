...
const PRODUCTS = [
  ...
  {id:3,  name:'Tops Veraniegos',  cat:'tops', price:15990, variant:'4 colores pastel · Personalizable', badge:'new', img:'img/catalog/tops/tops-veraniegos.jpg', images:[], swatches:['#F5E6D8','#E8A9A0','#C9C0E0','#A8C3A0'], desc:'Disponible en 4 tonos pastel. Diseño con colgante de hoja tejida y amarre ajustable al cuello.'},
  ...
  {id:8,  name:'Halter Top Negro Malla', cat:'tops', price:24990, variant:'Negro · Malla crochet · Exclusivo', badge:'', img:'img/catalog/tops/halter-top-negro-malla.jpg', images:[], swatches:['#1A1A1A'], desc:'Top de malla abierta tejida a crochet, diseño halter exclusivo con textura de rombos.'},
  ...
  {id:15, name:'Top Estándar',     cat:'tops', price:15990, variant:'Lila / Amarillo · Margaritas', badge:'', img:'img/catalog/tops/top-estandar.jpg', images:[], swatches:['#C9C0E0','#E8C23D'], desc:'Disponible de inmediato en lila y amarillo, con detalle de margaritas bordadas.'},
  ...
  {id:22, name:'Sombrero Rocío',   cat:'sombreros', price:14990, variant:'Rosa / Gris · Tejido grueso', badge:'', img:'img/catalog/sombreros/rocio.jpg', images:[], swatches:['#E0A0B0','#B8ADA5'], desc:'Sombrero de ala tejido con hebra gruesa en mezcla rosa y gris. Abrigador y liviano a la vez.'},
  ...
  {id:24, name:'Bolso Hobo Natural',   cat:'bolsos', price:27990, variant:'Crudo · Tejido grueso · Asa larga', badge:'new', img:'img/catalog/bolsos/bolso-hobo-natural.jpg', images:[], swatches:['#EDE6D8'], desc:'Bolso tipo hobo tejido a crochet en algodón crudo, con asa larga y forro interior. Precio referencial, sujeto a confirmación.'},
  {id:25, name:'Bolso Playero Malla',  cat:'bolsos', price:34990, variant:'Jute / Coral · Flecos', badge:'new', img:'img/catalog/bolsos/bolso-playero-fiesta.jpg', images:[], swatches:['#C9A876','#D9536E'], desc:'Bolso playero tejido en fibra jute con borde de flecos y detalle en coral. Precio referencial, sujeto a confirmación.'},
  {id:26, name:'Bolso Playero Natural', cat:'bolsos', price:34990, variant:'Jute / Crudo · Flecos', badge:'new', img:'img/catalog/bolsos/bolso-playero-natural.jpg', images:[], swatches:['#C9A876','#F2ECD9'], desc:'Bolso playero tejido en fibra jute con flecos en tono natural. Precio referencial, sujeto a confirmación.'},
  {id:27, name:'Bolso Boho Terracota', cat:'bolsos', price:19990, variant:'Terracota · Tejido calado', badge:'new', img:'img/catalog/bolsos/bolso-boho-terracota.jpg', images:[], swatches:['#B5552E'], desc:'Bolso tejido a crochet en tono terracota con textura calada y correa larga. Precio referencial, sujeto a confirmación.'},
  ...
  // ---- MITONES ----
  {id:23, name:'Mitones Andes',    cat:'mitones', price:9990, variant:'Gris oscuro · Borde afelpado', badge:'new', img:'img/catalog/mitones/mitones-andes.jpg', images:[], swatches:['#3A3A3A'], desc:'Mitones tejidos a palillos con borde afelpado ultra suave. Dejan los dedos libres para seguir con lo tuyo sin pasar frío.'},
];
